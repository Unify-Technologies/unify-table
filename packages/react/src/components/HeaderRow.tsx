...
export function HeaderRow({ column, sort, onSort, onResize, styles, px, py }: HeaderRowProps) {
  ...
  return (
    ...
    >
      <span style={{ whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis', display: 'flex', alignItems: 'center', gap: 4, paddingRight: resizable ? 8 : 0 }}>
        ...
        {column.editable !== false && (column.editor || column._isFormula) && <PencilLine size={10} style={{ opacity: 0.35, flexShrink: 0 }} />}
